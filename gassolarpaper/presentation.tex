...
\begin{frame}
    \frametitle{Defining the Latitude Requirement}
...
\begin{frame}
    \frametitle{Wind Speed vs Latitude Optimums}
...
\begin{frame}
    \frametitle{Wind Speed Impact on Operating Altitude}
...
\begin{frame}
    \frametitle{Defining Percentile Wind Speed}

...
$(E/S)_{\text{twilight}}$ \> low irradiance solar energy per unit area [Whr/m$^2$] \\
...
\begin{figure}[H]
    ...
    \caption{\textbf{Variation of wind speed by month at 45 degrees latitude at altitudes of 15,000 ft, 50,000 ft and 60,000 ft.  Lower, upper and middle lines represent 85th, 95th, and 90th percentile winds respectively.}}
	\label{f:windvsmonth}
	\end{center}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Variation of wind speed with altitude at latitudes of 30, 35, and 45 degrees.  Left, right and middle lines represent 85th, 95th, and 90th percentile winds respectively. Wind data includes winds during December for the years 2005-2015.}}
	\label{f:altvswind}
	\end{center}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Comparison of monomial approximation to Equation~\ref{e:gustalpha}, $V/V_{\text{gust}} \in [0,0.7]$. (Log space RMS error = 0.0246)}}
	\label{f:arctanfit}
	\end{center}
\end{figure}
...
where the fuel is assumed to have a density $\rho_\text{fuel} = 6.01$ [lbf/gallon].  The dimensions of the fuselage is constrained by
...
A comparison of the GP-compatible approximation to the manufacturing data from RCV engines is presented in Figure~\ref{f:powervsweightfit}. A comparison of the DF70 data provided by RCV Engine Ltd in Figure~\ref{f:powervsweightfit} to the $\text{BSFC}$ to power curves in Goering\cite{bsfcperf} verify that this performance curve is representative of engines of a similar class. 
...
\begin{figure}[H]
    ...
    \caption{\textbf{Trade study of max take off weight and operational latitude bands. Lower, upper and middle curves were evaluated at the 80th, 95th, and 90th percentile winds respectively.  The endurance requirement for the gas powered aircraft in this trade study is 7 days. The next integer latitude value for the solar-electric curves is infeasible.}}
    \label{f:latvsmtowtrade}
	\end{center}
\end{figure}
...
On the other hand, solar-electric powered aircraft design becomes less feasible at higher latitudes because even though wind speeds peak around 42 degrees latitude at 60,000 ft, the combination of lower solar flux and higher wind speeds makes it difficult to reach latitude bands greater than $\pm$30 degrees. 

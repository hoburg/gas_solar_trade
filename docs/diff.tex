...
%DIF ADD paperin_review.tex        Tue Apr 18 20:17:04 2017
%DIF -------
...
\DIFadd{The lapse is calculated from the required flight altitude $h=15,000$ }[\DIFadd{ft}]\DIFadd{, prior to the optimization solve using an approximate engine loss rate for normally aspirated engines of 3.5\% hp per 1000 ft,\mbox{%DIFAUXCMD
\cite{enginelapse}
}%DIFAUXCMD
}

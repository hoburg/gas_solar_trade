...
\begin{abstract}
    ...
    In this paper, the feasible limits of solar-elecrtic and gas powered, long-endurance aircraft are analyzed for various requirements and design variables to be used for initial vehicle sizing and design. 
    Additionally, this paper demonstrates the capability of geometric programming, a form of convex optimization, as a tool to evaluate the design trade offs between architectures and requirements.
...
% Known parameters from the Orion, Predator, Global Hawk, Hermes and Penguin (Table~\ref{t:existingparams}) aircraft are inputed to the optimization model.  
...
%     \caption{ \textbf{ Trade study between endurance and max take-off weight for a gas powered architecture. }}
...
The infeasible regions and contour shapes would change for different assumed constant values. 
 ...
 \begin{figure}[H]
 \begin{subfigmatrix}{3}% number of columns
  \subfigure[35th Latitude, $p_{\text{wind}}=0.80$]{\includegraphics[natwidth=542,natheight=414]{bcontourl35a80.eps}}
  \subfigure[35th Latitude, $p_{\text{wind}}=0.85$]{\includegraphics[natwidth=542,natheight=414]{bcontourl35a85.eps}}
  \subfigure[35th Latitude, $p_{\text{wind}}=0.90$]{\includegraphics[natwidth=542,natheight=414]{bcontourl35a90.eps}}
  \subfigure[30th Latitude, $p_{\text{wind}}=0.80$]{\includegraphics[natwidth=542,natheight=414]{bcontourl30a80.eps}}
  \subfigure[30th Latitude, $p_{\text{wind}}=0.85$]{\includegraphics[natwidth=542,natheight=414]{bcontourl30a85.eps}}
  \subfigure[30th Latitude, $p_{\text{wind}}=0.90$]{\includegraphics[natwidth=542,natheight=414]{bcontourl30a90.eps}}
  \subfigure[25th Latitude, $p_{\text{wind}}=0.80$]{\includegraphics[natwidth=542,natheight=414]{bcontourl25a80.eps}}
  \subfigure[25th Latitude, $p_{\text{wind}}=0.85$]{\includegraphics[natwidth=542,natheight=414]{bcontourl25a85.eps}}
  \subfigure[25th Latitude, $p_{\text{wind}}=0.90$]{\includegraphics[natwidth=542,natheight=414]{bcontourl25a90.eps}}
 \end{subfigmatrix}
...
Tables~\ref{t:svals} and ~\ref{t:gvals} list a few deisgn variables from both architectures for reference.

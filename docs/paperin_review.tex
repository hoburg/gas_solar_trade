...
Therefore, the station keeping requirement is defined as a percentage which is the percentile wind speed. 
...
$(E/S)_{\text{sun}}$, $(E/S)_{\text{day}}$, $(E/S)_{\text{twilight}}$, and $t_{\text{night}}$ are precomputed using the formulas in Appendix B to generate the fitted equations. 
...
\subsubsection{Wing Skin Weight}

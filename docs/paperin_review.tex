...
\begin{abstract}
    ...
    These aircraft present a complicated systems engineering problem because of the multifaceted interaction between aerodynamics, structural loads, environmental effects, and engine, battery, and other component performance.
